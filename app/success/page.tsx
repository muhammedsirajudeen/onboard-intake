            ...
            <div className="min-h-screen bg-white flex flex-col relative overflow-hidden">
                ...
                <div className="flex-1 flex items-center justify-center px-6 pt-24 pb-12 relative z-10">
                    <div className="max-w-xl w-full text-center">
                        ...
                        {/* Spam Warning Badge */}
                        <div className="inline-flex items-center gap-2 px-4 py-2 mb-10 bg-amber-50 border border-amber-200 rounded-full shadow-sm">
                            <svg className="w-4 h-4 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                            </svg>
                            <span className="text-sm font-medium text-amber-800">Check your spam folder for the email</span>
                        </div>
            ...
            <div className="flex-1 px-6 py-12">
                <div className="max-w-5xl mx-auto">
                    <div className="mb-10 text-center">
                        ...
                        {/* Spam Warning Badge */}
                        <div className="inline-flex items-center gap-2 px-4 py-2 mt-4 bg-amber-50 border border-amber-200 rounded-full shadow-sm">
                            <svg className="w-4 h-4 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                            </svg>
                            <span className="text-sm font-medium text-amber-800">Please check your spam folder if you don't see the email</span>
                        </div>
                    </div>
